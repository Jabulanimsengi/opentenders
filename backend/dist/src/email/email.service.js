...
let EmailService = EmailService_1 = class EmailService {
    ...
    fromEmail = process.env.SENDGRID_FROM_EMAIL || 'alerts@opentenderportal.co.za';
    fromName = 'Open Tender Portal';
    constructor() {
    ...
    async sendTenderMatchAlert(to, userName, searchName, tenders) {
    ...
    async sendClosingReminder(to, userName, tender) {
