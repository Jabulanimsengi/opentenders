 ...
 */
export function TenderViewGate({ tenderId, isSubscribed, children }: TenderViewGateProps) {
    ...
    return (
        <div className="relative">
            ...
            <div className="blur-md select-none pointer-events-none opacity-40" aria-hidden="true">
                {children}
            </div>
